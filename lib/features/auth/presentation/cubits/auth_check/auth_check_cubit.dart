...
class AuthCheckCubit extends Cubit<AuthCheckState> {
  ...
  //
  //     // If Remember Me is false, clear everything and go to login
  //     if (rememberMe == false) {
  //       dev.log(
  //         '🔒 Remember Me is disabled - clearing tokens and redirecting to login',
  //         name: 'AuthCheckCubit',
  //       );
  ...
  //     }
  //
  //     // ✅ Token is valid (refreshed or not), load profile from Hive
  //     dev.log(
  ...
  //     );
  //
  //     // ✅ Profile exists - navigate to home (LoginCubit will handle profile completion check)
