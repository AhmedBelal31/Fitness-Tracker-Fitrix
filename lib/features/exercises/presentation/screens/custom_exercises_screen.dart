...
//     // Navigate to select section screen
//     final result = await Navigator.pushNamed(context, Routes.selectSection);
//
//     // Refresh list if exercise was created
...
//
//   Widget _buildBody(BuildContext context, CustomExercisesState state, S s) {
//     // Extract exercises and loading states
//     List<ExerciseModel>? exercises;
//     bool isDeleting = false;
...
//               hasActiveFilters:
//                   _selectedDifficulty != null || _searchQuery.isNotEmpty,
//             ),
      ...
      children: [
        Column(
          children: [
            ...
            //       _selectedDifficulty != null || _searchQuery.isNotEmpty,
            // ),
            // In custom_exercises_screen.dart
            CustomExercisesFilterChips(
              selectedDifficulty: _selectedDifficulty,
              onFilterChanged: _handleFilterChange,
            ),
