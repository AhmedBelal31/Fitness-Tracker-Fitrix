...
//   }
// }
// ========== ANIMATED SECTION HEADER WITH THEME ==========
class AnimatedSectionHeader extends StatefulWidget {
  final IconData icon;
  final String title;
  final int count;
...
// ========== ANIMATED SEARCH BAR WITH THEME ==========
class AnimatedSearchBar extends StatefulWidget {
  final String hintText;
  final Function(String) onChanged;
  ...
  Widget build(BuildContext context) {
    ...
    return ScaleTransition(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: widget.hintText,
          hintStyle: TextStyle(color: ColorsManager.getSecondaryText(context)),
          prefixIcon: TweenAnimationBuilder<double>(
            tween: Tween(begin: 0.0, end: 1.0),
            duration: const Duration(milliseconds: 600),
            builder: (context, value, child) {
...
// ========== ANIMATED FILTER CHIP WITH THEME ==========
class AnimatedFilterChip extends StatefulWidget {
  final String label;
  final bool isSelected;
  final VoidCallback onTap;
  ...
  Widget build(BuildContext context) {
    ...
    return ScaleTransition(
      ...
      child: FilterChip(
        ...
        selectedColor: ColorsManager.getPrimaryGreen(context),
...
// ========== ANIMATED EMPTY STATE WITH THEME ==========
class AnimatedEmptyState extends StatefulWidget {
  final String message;
  final String subMessage;
