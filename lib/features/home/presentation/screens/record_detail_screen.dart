...
class _RecordDetailScreenState extends State<RecordDetailScreen>
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12.h),
            Text(
              widget.milestone.record.userExercise?.name ?? s.unknown_exercise,
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w600,
                color: ColorsManager.getPrimaryText(context),
        ...
        child: Row(
          ...
          children: [
            _buildStatItem(
              Icons.fitness_center,
              record.value.toStringAsFixed(record.recordType == 3 ? 0 : 1),
              _getRecordTypeLabel(record.recordType, s),
            ),
            _buildDivider(),
            _buildStatItem(
              Icons.calendar_today,
  ...
  Widget _buildStatItem(IconData icon, String value, String label) {
    return Column(
      children: [
        Icon(icon, color: ColorsManager.getPrimaryGreen(context), size: 28.sp),
        SizedBox(height: 8.h),
        Text(
          value,
          style: TextStyle(
  ...
  Widget _buildInfoRow(IconData icon, String label, String value) {
    return Row(
      children: [
        Icon(icon, size: 16.sp, color: ColorsManager.getSecondaryText(context)),
        SizedBox(width: 8.w),
        Text(
          '$label: ',
          style: TextStyle(
