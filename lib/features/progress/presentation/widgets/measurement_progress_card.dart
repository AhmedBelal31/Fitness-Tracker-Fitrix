...
//   }
//
//   Widget _buildStatsContainer(_CardData cardData) {
//     return Container(
...
//           ),
//           _buildDivider(),
//           _buildStat('Goal', cardData.goal.toStringAsFixed(1), cardData.unit),
//         ],
//       ),
//     );
//   }
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildStat(
            locale.goal,
            cardData.goal.toStringAsFixed(1),
            cardData.unit,
          ),
        ],
      ),
...
class _CardData {
  ...
  bool get isGoodChange => isPositiveGood ? change > 0 : change < 0;
}
