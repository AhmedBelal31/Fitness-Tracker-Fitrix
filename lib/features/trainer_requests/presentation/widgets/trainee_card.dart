...
class TraineeCard extends StatelessWidget {
  ...
  const TraineeCard({super.key, required this.trainee});
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Expanded(
              child: Text(
                s.sending_invitation_to(trainee.name),
                style: TextStyle(
                  fontSize: 16.sp,
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [ColorsManager.darkGreen, ColorsManager.secondaryGreen],
              ),
              borderRadius: BorderRadius.circular(12.r),
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20.r),
        border: Border.all(
          color: trainee.hasRequestPending
              ? ColorsManager.warning.withValues(alpha: 0.3)
              : ColorsManager.getPrimaryGreen(context).withValues(alpha: 0.15),
          width: 1.5,
        ),
        boxShadow: isDark
            ? [
      ...
      child: Column(
        children: [
                          ...
                          if (trainee.hasRequestPending)
                            Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  colors: [
                                    ColorsManager.warning.withValues(
                                      alpha: 0.2,
                                    ),
                                    ColorsManager.warning.withValues(
                                      alpha: 0.15,
          ...
          // Action Button - DARKER STYLE
          Padding(
            padding: EdgeInsets.all(16.w),
            child: SizedBox(
              width: double.infinity,
              child: trainee.isInRelation
                  ...
                  : // Send Invitation Button - DARKER GRADIENT
                    Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
