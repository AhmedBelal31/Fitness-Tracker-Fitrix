                ...
                children: [
                  Container(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: request.traineeProfilePicture != null
                          ? NetworkImage(request.traineeProfilePicture!)
                          : null,
                      child: request.traineeProfilePicture == null
                          ? Icon(
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      context.read<UserRequestsCubit>().acceptRequest(
                        request.id,
                      );
                    },
              ...
              Expanded(
                child: OutlinedButton(
                  onPressed: () {
                    context.read<UserRequestsCubit>().rejectRequest(request.id);
                  },
